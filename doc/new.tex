...
In the present study, we test this possibility by examining whether human affective ratings predict CLIP’s attentional priority across competing visual contents.
...
\begin{figure}[h]
  ...
  All $p$-values are Bonferroni-corrected across all planned tests. Filled circles indicate corrected $p < .05$; open circles indicate non-significant effects.}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.82\textwidth]{plots/S2_OASIS_example.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{plots/S1_landscape.pdf}
